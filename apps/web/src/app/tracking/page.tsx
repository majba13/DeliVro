...
function TrackingContent() {
  ...
  const currentIdx = Math.max(0, TIMELINE.findIndex((s) => s.status === currentStatus));
  const etaMinutes = (update as { etaMinutes?: number | null })?.etaMinutes;
  const updatedAt = (update as { updatedAt?: string | null })?.updatedAt;
